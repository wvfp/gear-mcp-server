...
Assistentes de IA tradicionais podem escrever GDScript, mas estão essencialmente trabalhando às cegas. Eles geram código com base em dados de treinamento, esperando que funcione. **Gear muda tudo:**
...
Gear usa uma arquitetura híbrida:
...
- **Pacote npm** — instale com `npx Gear` ou `npm install -g Gear`
